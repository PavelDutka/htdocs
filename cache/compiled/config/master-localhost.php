...
return [
    ...
    'timestamp' => 1685906569,
    'checksum' => '05a62feef8612327e16f0bc51d0ddf4d',
    'files' => [
        'user/config' => [
            'media' => [
        ...
        'user/themes' => [
            'themes/main-theme' => [
                'file' => 'user/themes/main-theme/main-theme.yaml',
                'modified' => 1685299734
            ]
        ]
    ],
...
node_modules'
        ...
        'site' => [
            ...
            'metadata' => [
                'description' => 'nechapu jak to fungujfadsfoiosdifojvsnv'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
